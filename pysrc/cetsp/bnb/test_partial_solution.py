...
def test_trivial_feasible():
    ...
    partial_solution = PartialSolution(instance, [Circle(0,0,1), Circle(1.5, 0.5, 1), Circle(3,0,1)])
...
def test_other():
    instance = TourInstance(
        [Circle(0, 0, 1), Circle(3, 0, 1), Circle(5, 2, 1), Circle(3, 3, 1),
         Circle(0, 4, 1)])
    part_sol = PartialSolution(instance,
        [Circle(0, 0, 1), Circle(5, 2, 1), Circle(3, 3, 1), Circle(3, 0, 1),
         Circle(0, 4, 1)])
