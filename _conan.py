...
class ConanHelper:
    ...
    def __init__(self, generator_folder=".conan", local_conans=None, settings=None):
        self.generator_folder = os.path.abspath(generator_folder)
        self.local_conans = local_conans if local_conans else []
